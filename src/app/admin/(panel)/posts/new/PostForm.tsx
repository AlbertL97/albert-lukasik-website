...
const schema = z.object({
  ...
  post_type: z.enum(['article', 'vlog', 'note', 'resource_list']),
...
export default function PostForm({ defaultValues, postId }: PostFormProps) {
  ...
  const [slugManual, setSlugManual] = useState(!!postId)
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 max-w-2xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
          ...
          <select {...register('post_type')} className={selectClass}>
        ...
        <div className="md:col-span-2">
          ...
          <input {...register('tags')} className={inputClass} placeholder="ai, research, cognition" />
        </div>

        <div className="md:col-span-2">
          <label className={labelClass}>Video URL (for vlogs)</label>
