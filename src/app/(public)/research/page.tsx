...
const STATIC_PROJECTS: Project[] = [
  ...
  },
  {
    ...
    summary: 'Personal health intelligence dashboard integrating Apple Health data, genome VCF files, and Nebula Genomics reports across 9 body-system domains.',
    description: '',
    project_type: 'UX Research',
    role: 'Designer & Developer',
    methods: ['Data Visualization', 'UX Design', 'Systems Design'],
  ...
  },
  {
    ...
    summary: 'Experimental study examining how perceptual dimensions of virtual objects affect depth judgement and spatial cognition in mixed-reality environments.',
    description: '',
